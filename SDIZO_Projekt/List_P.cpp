...
List_P::List_Node * List_P::get_head()
{
	return this->head;
}

List_P::List_Node * List_P::get_tail()
{
	return this->tail;
}

void List_P::push_front(const int el)
{
...
void List_P::push_back(const int el)
{
	List_Node * newElement = new List_Node();
	newElement->value = el;
	if (this->tail)
...
void List_P::insert(const int el, const int pos)
{
	if (pos == 0) 
	{
		this->push_front(el);
...
void List_P::remove(const int pos)
{
	if (pos == 0)
	{
		this->remove_front();
...
void List_P::set_num(const int new_num, const int pos)
{
